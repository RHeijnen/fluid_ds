...
import type { FluidSelect } from "@fluid-ds/components";
...
export function Shell({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    if (!path.startsWith("/ssr-contract")) void import("./register-fluid");
  }, [path]);
  ...
  const brandRef = useFluidEvent<FluidSelect>("fluid-change", (e) => {
