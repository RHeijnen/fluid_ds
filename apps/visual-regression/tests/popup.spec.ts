...
test.describe("Components/Popup", () => {
  test("Default", async ({ page }) => {
    await page.goto(`/iframe.html?id=components-popup--default&viewMode=story`);
    ...
    if (sbErr) {
      throw new Error(`Storybook failed to render story 'components-popup--default': ${sbErr.trim()}`);
    }
