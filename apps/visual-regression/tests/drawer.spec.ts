...
test.describe("Components/Drawer", () => {
  test("AllPlacements", async ({ page }) => {
    await page.goto(`/iframe.html?id=components-drawer--all-placements&viewMode=story`);
    ...
    if (sbErr) {
      throw new Error(`Storybook failed to render story 'components-drawer--all-placements': ${sbErr.trim()}`);
    }
