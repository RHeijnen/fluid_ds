...
test.describe("Observers/Intersection observer", () => {
  test("Default", async ({ page }) => {
    await page.goto(`/iframe.html?id=observers-intersection-observer--default&viewMode=story`);
    ...
    if (sbErr) {
      throw new Error(`Storybook failed to render story 'observers-intersection-observer--default': ${sbErr.trim()}`);
    }
