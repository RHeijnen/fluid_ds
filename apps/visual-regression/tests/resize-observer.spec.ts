...
test.describe("Observers/Resize observer", () => {
  test("Default", async ({ page }) => {
    await page.goto(`/iframe.html?id=observers-resize-observer--default&viewMode=story`);
    ...
    if (sbErr) {
      throw new Error(`Storybook failed to render story 'observers-resize-observer--default': ${sbErr.trim()}`);
    }
